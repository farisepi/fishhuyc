...
func _on_play_button_pressed() -> void:
	...
	_goto_scene("res://Fish Slaves/Base/Scenes/Menus/SavesMenu.tscn")

func _on_settings_button_pressed() -> void:
	Global.came_from = Global.MenuSource.MAIN_MENU
	_goto_scene("res://Fish Slaves/Base/Scenes/Menus/SettingsMenu.tscn")

func _on_achivments_button_pressed() -> void:
	Global.came_from = Global.MenuSource.MAIN_MENU
	_goto_scene("res://Fish Slaves/Base/Scenes/Menus/AchievementsMenu.tscn")
