...
func _on_save_pressed() -> void:
	...
	get_tree().paused = false
	hide()
	get_tree().change_scene_to_file("res://Fish Slaves/Base/Scenes/Menus/SavesMenu.tscn")
...
func _on_settings_pressed() -> void:
	...
	get_tree().paused = false
	hide()
	get_tree().change_scene_to_file("res://Fish Slaves/Base/Scenes/Menus/SettingsMenu.tscn")
