...
func _set_achievement_gray(ach: Control, icon: TextureRect, check: TextureRect, name_label: Label) -> void:
	ach.modulate = Color(0.3, 0.3, 0.3, 1.0)
...
func _on_reset_pressed() -> void:
	...
	menu.dialog_text = "Весь ваш текущий прогресс достижений будет сброшен. Восстановить будет уже нельзя. Вы уверены?"
